...
// GET /settings
router.get("/settings", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// GET /admin
router.get("/admin", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (_req: Request, res: Response) => {
  return res.redirect("/admin/users");
});

// GET /admin/users
router.get("/admin/users", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (_req: Request, res: Response) => {
...
// POST /admin/users/:id
router.post("/admin/users/:id", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  await db("users")
    .update({
...
router.post("/admin/users/:uid/apps/:aid", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  await db("apps")
    .update({
      name: req.body.name,
      url: req.body.url,
...
// GET /admin/jobs
router.get("/admin/jobs", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/admin/jobs/:id/retry", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/admin/jobs/:id/delete", authenticationMiddleware, adminOnlyMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const jobId = parseInt(req.params.id as string);
...
router.get("/settings/account", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  return res.render("settings-account.html", {
    title: "Account",
    user: req.session?.user,
...
// GET /settings/data
router.get("/settings/data", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// POST /settings/data
router.post("/settings/data", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.get("/settings/danger-zone", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/settings/danger-zone/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// GET /notifications
router.get("/notifications", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/notifications/read", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// GET /apps
router.get("/apps", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const filter = req.query.filter as string;
...
// GET /apps/create
router.get("/apps/create", authenticationMiddleware, csrfMiddleware, async (_req: Request, res: Response) => {
...
// GET /apps/:id
router.get("/apps/:id", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const user = req.session?.user;
...
// GET /apps/:id/edit
router.get("/apps/:id/edit", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
...
// POST /apps/:id
router.post("/apps/:id", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// POST /apps/:id/delete
router.post("/apps/:id/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.get("/apps/:id/channels", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const userTimezone = req.session?.user?.timezone || "UTC";
...
router.get("/apps/:id/channels/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.post("/apps/:id/channels/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:id/channels/export", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const appId = req.params.id;
  const userId = req.session?.user?.id;
...
router.get("/apps/:id/channels/create", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.post("/apps/:id/channels/discord", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/apps/:id/create-api-key", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/apps/:id/channels/sms", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/apps/:id/channels/email", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/apps/:aid/channels/:cid/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.get("/apps/:id/channels/:cid/configs/:cfid/edit", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:id/channels/:cid/configs/:cfid/sms", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:id/channels/:cid/configs/:cfid/discord", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id, cfid, cid } = req.params;
  const { name, is_active, webhook_url } = req.body;
...
router.post("/apps/:id/channels/:cid/configs/:cfid/email", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id, cfid, cid } = req.params;
...
router.get("/apps/:id/notifications", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const appId = req.params.id;
  const perPage = parseInt(req.query.perPage as string) || 10;
  const currentPage = parseInt(req.query.page as string) || 1;
...
router.get("/apps/:id/settings", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.post("/apps/:id/notifications/:nid/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:aid/notifications/:nid/read", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:aid/notifications/read", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/apps/:id/notifications/test", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
  const { message, details } = req.body;
...
router.post("/settings/data/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const user = req.session?.user as User;
