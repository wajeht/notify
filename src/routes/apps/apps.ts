...
// GET /apps/create
router.get("/create", authenticationMiddleware, csrfMiddleware, async (_req: Request, res: Response) => {
...
// GET /apps/:id
router.get("/:id", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const user = req.session?.user;
...
// GET /apps/:id/edit
router.get("/:id/edit", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
...
// POST /apps/:id
router.post("/:id", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// POST /apps/:id/delete
router.post("/:id/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:id/create-api-key", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.get("/:id/channels", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.get("/:id/channels/create", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.get("/:id/channels/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.post("/:id/channels/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:id/channels/export", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const appId = req.params.id;
  const userId = req.session?.user?.id;
...
router.post("/:id/channels/discord", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/:id/channels/sms", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/:id/channels/email", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post("/:aid/channels/:cid/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.get("/:id/channels/:cid/configs/:cfid/edit", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:id/channels/:cid/configs/:cfid/sms", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:id/channels/:cid/configs/:cfid/discord", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id, cfid, cid } = req.params;
  const { name, is_active, webhook_url } = req.body;
...
router.post("/:id/channels/:cid/configs/:cfid/email", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id, cfid, cid } = req.params;
...
router.get("/:id/notifications", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const appId = req.params.id;
  const perPage = parseInt(req.query.perPage as string) || 10;
...
router.get("/:id/settings", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const app = await db
    .select("*")
    .from("apps")
    .where({ id: req.params.id, user_id: req.session?.user?.id })
...
router.post("/:id/notifications/:nid/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:aid/notifications/:nid/read", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:aid/notifications/read", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/:id/notifications/test", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const { id } = req.params;
