  ...
  const apps = [
    {
      ...
      user_monthly_limit_threshold: 25,
      alerts_sent_this_month: 15,
      alerts_reset_date: new Date("2024-02-01"),
      created_at: new Date("2024-01-15"),
      updated_at: new Date("2024-02-01"),
    },
    {
      ...
      max_monthly_alerts_allowed: 100,
      user_monthly_limit_threshold: 30,
      alerts_sent_this_month: 8,
      alerts_reset_date: new Date("2024-02-01"),
      created_at: new Date("2024-01-20"),
    ...
    },
    {
      ...
      max_monthly_alerts_allowed: 100,
      user_monthly_limit_threshold: 20,
    ...
    },
    {
      ...
      max_monthly_alerts_allowed: 100,
      user_monthly_limit_threshold: 40,
      alerts_sent_this_month: 22,
      alerts_reset_date: new Date("2024-02-01"),
    ...
    },
    {
      ...
      max_monthly_alerts_allowed: 100,
      user_monthly_limit_threshold: 15,
      alerts_sent_this_month: 5,
      alerts_reset_date: new Date("2024-02-01"),
    ...
    },
    {
      ...
      max_monthly_alerts_allowed: 100,
      user_monthly_limit_threshold: 35,
      alerts_sent_this_month: 12,
      alerts_reset_date: new Date("2024-02-01"),
