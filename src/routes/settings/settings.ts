...
router.get("/account", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  return res.render("settings/account.html", {
    title: "Account",
    user: req.session?.user,
...
// GET /settings/data
router.get("/data", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
// POST /settings/data
router.post("/data", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response): Promise<void> => {
...
router.post("/data/import", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
  const user = req.session?.user as User;
...
router.get("/danger-zone", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
...
router.post("/danger-zone/delete", authenticationMiddleware, csrfMiddleware, async (req: Request, res: Response) => {
